function genGrid(dimension = 16) {
    for (i = 0; i < dimension ** 2 - 1; i++) {
        ...
        div.style.height = `${89.0 / dimension}%`;
...
function getSize() {
    let dimension = prompt("Please enter a number between 0 and 20. If you enter 16, the grid dimension will be 64x64.")
    console.log(parseInt(dimension));
    if (!(parseInt(dimension)) || (dimension < 1 || dimension > 20)) {
